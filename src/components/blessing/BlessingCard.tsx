      ...
      >
        ...
        <div className="flex items-center justify-between">
          {blessing.teacher ? (
            ...
            <span className="flex items-center gap-1 rounded-full bg-accent/10 px-3 py-0.5 text-xs text-accent">
              <span aria-hidden="true">{blessing.gift.icon}</span>
              {blessing.gift.name} · 献给全体老师
            </span>
          ) : (
            <span />
          )}
