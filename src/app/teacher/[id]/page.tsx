  ...
  return (
    <main className="min-h-screen">
      ...
      <div className="mx-auto max-w-3xl px-4 py-12">
        ...
        {/* v2.0 叙事说明（UX-2）：本页展示往年定向祝福，今年的新祝福献给全体老师 */}
        <div className="glass-card mb-6 flex flex-col items-center gap-2 px-4 py-3 text-center sm:flex-row sm:justify-center sm:gap-3">
          <p className="text-xs text-ink-light">📖 这里展示往年送给 {teacher.name}老师的定向祝福</p>
          <a href="/wall" className="text-xs font-medium text-accent hover:text-accent-light">
            今年的新祝福献给全体老师，去祝福星河看看 →
          </a>
        </div>
